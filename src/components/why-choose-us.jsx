    ...
    <div className="bg-[#9F2B2B] text-white py-12 px-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-20">
          <div className="flex flex-col	justify-between pl-0 text-center col-span-1 lg:col-span-1">
            <div>
            <h2 className="text-4xl text-left font-bold mb-4">Why Choose Us</h2>
            <p className="mb-8 text-base text-left">Beyond haircut, discover a comprehensive range of services, from colouring to extensions</p>
            </div>
